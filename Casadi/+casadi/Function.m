classdef  Function < casadi.SharedObject & casadi.PrintableCommon
  ...
  methods
    ...
    %N_INSTRUCTIONS Number of instruction in the algorithm ( SXFunction)
    %
    ...
    %INSTRUCTION_ID Identifier index of the instruction ( SXFunction)
    %
    ...
    %INSTRUCTION_INPUT Locations in the work vector for the inputs of the instruction ( SXFunction)
    %
    %  [int,int] = INSTRUCTION_INPUT(self, int k)
    %
    %
    %
    %
    ...
    %INSTRUCTION_OUTPUT Location in the work vector for the output of the instruction ( SXFunction)
    %
