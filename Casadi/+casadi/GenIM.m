classdef  GenIM < casadi.GenericMatrixCommon & casadi.SparsityInterfaceCommon
  ...
  methods
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(228, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(230, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(231, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(232, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(233, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(234, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(235, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(236, self, varargin{:});
    end
    ...
    %
    %
      out = casadiMEX(238, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
