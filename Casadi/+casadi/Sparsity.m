classdef  Sparsity < casadi.SharedObject & casadi.SparsityInterfaceCommon & casadi.PrintableCommon
  ...
  methods
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(74, self, varargin{:});
    end
    ...
    %
    %
      out = casadiMEX(92, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(152, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(154, varargin{:});
    end
  end
end
