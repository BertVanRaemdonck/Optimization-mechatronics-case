classdef  GenMX < casadi.GenericMatrixCommon & casadi.SparsityInterfaceCommon
  ...
  methods
    ...
    %
    %
      out = casadiMEX(322, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(335, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(336, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(337, varargin{:});
    end
  end
end
